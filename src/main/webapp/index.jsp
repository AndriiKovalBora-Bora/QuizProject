    ...
    <section>
        <div class="container">
            <div style="margin: 0px;margin-top: 13rem;margin-bottom: 53px;">
                <div class="text-center" style="margin-bottom: 32px;margin-top: -26px;"><label style="font-size: 27px;"><fmt:message key="statistics.history"/></label></div>
                <div class="table-responsive border-light" style="background-color: #f4dfdf;">
                    <table class="table table-striped">
                        ...
                        <tbody>
                        <%--@elvariable id="statisticsHistory" type="java.util.List"--%>
                        <c:forEach var="statistics" items="${statisticsHistory}">
                            <tr>
                    ...
                    <ul class="pagination">
                        ...
                        <c:if test="${currentPage != 1}">
                            <li class="page-item"><a class="page-link"
                                                     href="${pageContext.request.contextPath}/app/index?currentPage=${currentPage-1}"><fmt:message key="previous"/></a>
                            </li>
                        </c:if>
                        ...
                        <c:forEach begin="1" end="${noOfPages}" var="i">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <li class="page-item"><a class="page-link"
                                                             href="${pageContext.request.contextPath}/app/index?currentPage=${i}">${i}</a>
                                    </li>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                        ...
                        <c:if test="${currentPage lt noOfPages}">
                            <li class="page-item"><a class="page-link"
                                                     href="${pageContext.request.contextPath}/app/index?currentPage=${currentPage+1}"><fmt:message key="next"/></a>
                            </li>
                        </c:if>
                    </ul>
                </nav>
