...
<main style="margin-top: 162px;">
    <section>
        <div class="container">
            <div class="text-center"><label style="font-size: 27px;color: rgb(37,79,3);font-family: Anton, sans-serif;"><fmt:message key="registation.page.seccessful.registration"/></label></div>
            <div>
