...
<div class="container">
    <div class="text-center" style="padding-top: 22px;">
        <form action="${pageContext.request.contextPath}/app/playerGame" method="post">
            <button class="btn btn-primary" type="submit" name="finish" value="finish"><fmt:message key="finish.game"/></button>
        </form>
    </div>
</div>
