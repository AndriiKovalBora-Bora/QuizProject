...
<main style="margin-top: 162px;">
    <section>
        <c:if test="${not empty requestScope.activeGame}">
        <div class="container">
            ...
            <div class="text-center"><label style="font-size: 28px;font-family: 'Fjalla One', sans-serif;"><fmt:message
                    key="time.left"/> :&nbsp;</label><label
                    style="font-family: 'Fjalla One', sans-serif;font-size: 28px;color: rgb(136,6,6);"
                    id="timer"></label>
                ...
                <div>
                    <div class="row">
                        ...
                        <div class="col" style="background-color: #e3d8d8;">
                            ...
                            <div><label style="font-family: Allerta, sans-serif;"><fmt:message
                                    key="statistics.after.game.format"/></label>
                            </div>
            ...
            <c:if test="${empty requestScope.activeGame}">
            <div class="text-center"><label style="font-size: 27px;"><fmt:message key="no.active.game"/></label></div>
            </c:if>
    </section>
</main>
<br>
