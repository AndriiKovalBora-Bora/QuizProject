                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div style="margin: 0px; margin-top: 2rem; margin-bottom: 53px;width: 273px;background-color: #e1d4d4;margin-left: 140px;">
                            ...
                            <div><label style="margin-left: 20px;">${requestScope.administrator.name}</label></div>
                            <div><label style="font-family: Allerta, sans-serif;margin-left: 15px;"><fmt:message key="surname"/></label>
                            </div>
                            <div><label style="margin-left: 20px;">${requestScope.administrator.surname}</label></div>
                            <div><label style="font-family: Allerta, sans-serif;margin-left: 15px;"><fmt:message key="surname"/></label>
                            </div>
                            <div><label style="margin-left: 20px;">${requestScope.administrator.email}</label></div>
                        </div>
                    </div>
                    <div class="col">
