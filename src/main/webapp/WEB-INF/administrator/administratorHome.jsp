                    ...
                    <ul class="pagination">
                        ...
                        <c:if test="${currentPage != 1}">
                            <li class="page-item"><a class="page-link"
                                                     href="${pageContext.request.contextPath}/app/administratorHome?currentPage=${currentPage-1}"><fmt:message key="previous"/></a>
                            </li>
                        </c:if>
                        ...
                        <c:forEach begin="1" end="${noOfPages}" var="i">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <li class="page-item"><a class="page-link"
                                                             href="${pageContext.request.contextPath}/app/administratorHome?currentPage=${i}">${i}</a>
                                    </li>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                        ...
                        <c:if test="${currentPage lt noOfPages}">
                            <li class="page-item"><a class="page-link"
                                                     href="${pageContext.request.contextPath}/app/administratorHome?currentPage=${currentPage+1}"><fmt:message key="next"/></a>
                            </li>
                        </c:if>
                    </ul>
                </nav>
